    ...
    >
      <div className="mx-auto flex flex-col gap-8 sm:gap-16 items-center justify-center">
        ...
        >
          ...
          <g>
            <path d="M28.44,126.74h2.14l6.41,14.96h-2.38l-.9-2.14h-8.39l-.86,2.14h-2.43l6.41-14.96ZM32.8,137.42l-3.29-7.89-3.29,7.89h6.58Z" />
            <path d="M42.76,126.74h2.43v9.95l9.74-9.95h3l-4.44,4.56,4.52,10.4h-2.67l-3.7-8.55-6.45,6.66v1.89h-2.43v-14.96Z" />
            <path d="M63.77,126.74h2.43v14.96h-2.43v-14.96Z" />
            <path d="M72.9,139.36l11.96-10.48h-11.96v-2.14h15.09v2.34l-11.92,10.48h11.8v2.14h-14.96v-2.34Z" />
            <path d="M94.32,135.37v-8.63h2.42v8.84c0,2.34,1.77,4.15,4.15,4.15s4.11-1.81,4.11-4.15v-8.84h2.43v8.63c0,3.95-3.04,6.54-6.66,6.54s-6.45-2.59-6.45-6.54Z" />
            <path d="M114.18,126.74h2.43v9.95l9.74-9.95h3l-4.44,4.56,4.52,10.4h-2.67l-3.7-8.55-6.45,6.66v1.89h-2.43v-14.96Z" />
            <path d="M135.2,126.74h2.43v14.96h-2.43v-14.96Z" />
          </g>
        </svg>
      </div>
